...
PAGES = [
    ...
    (
        ...
        "course_pm",
        "Курс перманентного макияжа в Москве — Академия Agent Permanent",
        "Гос. диплом + 5 дней практики в Москве. Курс мастера ПМ: брови, губы, межресничка. 200+ выпускниц, рассрочка, обучение с нуля.",
    ),
    (
